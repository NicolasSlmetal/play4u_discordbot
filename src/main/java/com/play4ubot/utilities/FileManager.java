...
public class FileManager {
    ...
    public String removeSymbols(String name, String ext){
        ...
        replicant = replicant.replaceAll("[1-9]{1,3}[Kk]", "").trim();
        replicant = replicant.replaceAll("\\s[Hh][DdQq]($|\\s)", "");
        replicant = replicant.replaceAll("[Ll][eE][gG][eE][nN][dD][aA][dD][oO]", "");
        replicant = replicant.replaceAll("[aAÁá][uU][dD][iI][oO](\\s|$)", "");
        replicant = replicant.replaceAll("[Ll][yY][rR][iI][cC]([sS]*)", "");
        replicant = replicant.replaceAll("[oO][fF]{1,2}[iI][cC][iI][aA][lL]\\s([Vv][IiÍí][Dd][eE][oO]|[aAÁá][uU][dD][iI][oO]|[mM][uU][sS][iI][cC](\\s|$))", "");
        replicant = replicant.replaceAll("[Vv][IiÍí][Dd][eE][oO](\\s|$)", "");
        replicant = replicant.replaceAll("[Tt][rR][aA][dD][uU][çÇ][ãÃaA][oO]", "");
